            ...
            <div id="other">
                ...
                <div className="receipt-block3">
                    ...
                    <ul>
                        ...
                        <li>
                            <form name="from1">
                                <input type="radio" value="客户自交" name="chose" style={{width: "20px", height: '20px'}}/><label>客户自交</label>
                                <input type="radio" value="上门收取" name="chose" style={{width: "20px", height: '20px'}}/><label>上门收取</label>
                                <input type="radio" value="委托银行转账" name="chose" style={{width: "20px", height: '20px'}}/><label>委托银行转账</label>
                            </form>
                        </li>
            ...
            <div id="dialog" style={{ display:'none'}}>
                ...
                <div className="bottom text18 tc-primary">
                    ...
                    <div className="divx" onClick={this.submit.bind(this)}>
                        <div className="ml-0 mr-0" style={{width:"390px", textAlign:"right"}} onClick={() => {
                            alert('提交成功');
